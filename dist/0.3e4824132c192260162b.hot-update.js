...
function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; } // Packages
...
var fields = [{
    ...
    type: _Constants2.default.InputType.DROPDOWN,
    label: 'Dropdown',
    selectedValue: '1',
    value: 'value'
}, _defineProperty(_ref, 'label', 'label'), _defineProperty(_ref, 'name', 'dropdown'), _defineProperty(_ref, 'input', {
    options: [{
        value: '1',
        label: 'Drop 1'
    }, {
